(window["webpackJsonp_mf_food_blog"] = window["webpackJsonp_mf_food_blog"] || []).push([["style-index"],{
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_mf_food_blog"] = window["webpackJsonp_mf_food_blog"] || [];
...
function ingredients(props) {
  var handleAddIngredient = function handleAddIngredient() {
    var ingredients = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(props.attributes.ingredients);
  ...
  var handleRemoveIngredient = function handleRemoveIngredient(index) {
    var ingredients = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(props.attributes.ingredients);
  ...
  var handleIngredientChange = function handleIngredientChange(key, value, index, e) {
    var ingredients = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(props.attributes.ingredients);
  ...
  var maybeAddIngredient = function maybeAddIngredient(key, event, ingredients) {
    if (['name', 'extra'].indexOf(key) !== -1 && event.key === 'Enter' && ingredients[ingredients.length - 1].amount !== '') {
      handleAddIngredient();
    }
  };

  var ingredientFields, ingredientDisplay;
  ...
  if (props.attributes.ingredients.length) {
    ingredientFields = props.attributes.ingredients.map(function (ingredient, index) {
      return [Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
        ...
        min: "0",
        onChange: function onChange(amount, e) {
        ...
        onClick: function onClick() {
          return handleRemoveIngredient(index);
        }
      }))];
    });
    ingredientDisplay = props.attributes.ingredients.map(function (ingredient, index) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, ingredient.amount, " ", pluralOrSingularUnit(props, index, ingredient.unit), " ", ingredient.name);
    });
  }

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", Object(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__["useBlockProps"])(), ingredientFields, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["Button"], {
    isDefault: true,
    onClick: handleAddIngredient.bind(this)
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Add Ingredient')));
}
...
Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__["registerBlockType"])('finell/ingredients', {
  /**
   * @see https://make.wordpress.org/core/2020/11/18/block-api-version-2/
   */
  apiVersion: 2,
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Ingredients', 'mf-food-blog'),
  description: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Block used to list ingredients', 'mf-food-blog'),
  category: 'text',
  icon: 'carrot',
  supports: {
  ...
  edit: _edit__WEBPACK_IMPORTED_MODULE_3__["ingredients"],
  save: _save__WEBPACK_IMPORTED_MODULE_4__["ingredients"]
});
